Contributing to DIGIWAGE Core
============================

The DIGIWAGE Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/digiwage-project/digiwage/blob/master/doc/translation_process.md)
...
The following applies to code changes to the DIGIWAGE Core project, and is not to be
confused with overall DIGIWAGE Network Protocol consensus changes.

Whether a pull request is merged into DIGIWAGE Core rests with the project merge
...
Patches that change DIGIWAGE consensus rules are considerably more involved than
...
Where a patchset proposes to change the DIGIWAGE consensus, it must have been
...
The project leader is the release manager for each DIGIWAGE Core release.
