...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/digiwage.conf}
...
then
  ...
  echo -e "To safely generate a digiwage.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example digiwage.conf file in share/examples/'
