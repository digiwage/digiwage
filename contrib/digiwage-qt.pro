...
RESOURCES += src/qt/digiwage.qrc src/qt/digiwage_locale.qrc

TRANSLATIONS += src/qt/locale/digiwage_bg.ts \
                src/qt/locale/digiwage_de.ts \
                src/qt/locale/digiwage_en.ts \
                src/qt/locale/digiwage_es.ts \
                src/qt/locale/digiwage_fi.ts \
                src/qt/locale/digiwage_fr.ts \
                src/qt/locale/digiwage_it.ts \
                src/qt/locale/digiwage_ja.ts \
                src/qt/locale/digiwage_pl.ts \
                src/qt/locale/digiwage_pt.ts \
                src/qt/locale/digiwage_ru.ts \
                src/qt/locale/digiwage_sk.ts \
                src/qt/locale/digiwage_sv.ts \
