...
complete --command digiwaged --no-files

# Extract options
function __fish_digiwaged_get_options
...
complete \
    --command digiwaged \
    --arguments "(__fish_digiwaged_get_options --nofiles)"
