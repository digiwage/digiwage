...
complete --command digiwage-qt --no-files

# Extract options
function __fish_digiwageqt_get_options
...
complete \
    --command digiwage-qt \
    --arguments "(__fish_digiwageqt_get_options --nofiles)"
