...
# Extract options
function __fish_digiwage_tx_get_options
...
# Extract commands
function __fish_digiwage_tx_get_commands
...
complete \
    --command digiwage-tx \
    --condition "not __fish_digiwage_seen_cmd (__fish_digiwage_tx_get_commands --commandsonly)" \
    --arguments "(__fish_digiwage_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command digiwage-tx \
    --arguments "(__fish_digiwage_tx_get_commands)" \
    --no-files
