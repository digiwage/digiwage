...
"""
Note, these tests do not test the functionality of the DGP template contract itself, for tests for the DGP template, see digiwage-dgp.py
"""
class DigiWageDGPActivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart the digiwaged to verify that no crashes occurs on startup
        self.stop_nodes()
        self.start_nodes()


if __name__ == '__main__':
    DigiWageDGPActivation().main()
