...
class ListReceivedTest (PivxTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 WAGE.
        ...
        # Send 1 WAGE to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 WAGE sending them all (fee is 0.1 WAGE)
        ...
        # Confirm transaction (2 WAGE from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 WAGE, send 0.6 WAGE + 0.05 WAGE fee
