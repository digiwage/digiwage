...
COIN = 100000000 # 1 WAGE in satoshis
...
# Objects that map to digiwaged objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in digiwaged indicates these should be deserialized as blocks
