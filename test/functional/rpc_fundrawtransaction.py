...
class RawTransactionsTest(DigiwageTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid digiwage address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid digiwage address" in e.error['message'])
