...
from test_framework.digiwageconfig import ENABLE_REDUCED_BLOCK_TIME

import sys


RPC_INVALID_PARAMETER = -8
class DigiWageRPCSearchlogsTestModified(BitcoinTestFramework):
...
if __name__ == '__main__':
    DigiWageRPCSearchlogsTestModified().main()
