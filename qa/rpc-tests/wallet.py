...
#   c) node1 mines 32 blocks, so now node 0 has 60001wage, node 1 has 4250wage, node2 has none.
#   d) node0 sends 601 wage to node2, in two transactions (301 wage, then 300 wage).
