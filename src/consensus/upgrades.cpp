...
const struct NUInfo NetworkUpgradeInfo[Consensus::MAX_NETWORK_UPGRADES] = {
        ...
        {
                /*.strName =*/ "Stk_v2",
                /*.strInfo =*/ "256 bit stake modifier",
        },
                {
                /*.strName =*/ "Block_v4",
                /*.strInfo =*/ "start block v4 ",
        },
        {
                /*.strName =*/ "BIP65_TV2_MSGV2",
                /*.strInfo =*/ "CLTV (BIP65) activation - Time Protocol start, New Message Sigs, start block v5",
        },
        {
                /*.strName =*/ "DIGIWAGE_v3_shield",
                /*.strInfo =*/ "Sapling Shield - start transaction v3, New cold-staking rules, New staking rules, start block v6",
        },
        {
                /*.strName =*/ "DIGIWAGE_vNext_evo",
