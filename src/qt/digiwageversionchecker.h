#ifndef DIGIWAGEVERSIONCHECKER_H
#define DIGIWAGEVERSIONCHECKER_H

#include <QObject>

#define DIGIWAGE_RELEASES "https://github.com/digiwageproject/digiwage/releases"
...
class DigiWageVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit DigiWageVersionChecker(QObject *parent = 0);
    ~DigiWageVersionChecker();
...
#endif // DIGIWAGEVERSIONCHECKER_H
