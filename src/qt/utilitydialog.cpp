...
// Copyright (c) 2015-2017 The DIGIWAGE developers
...
#include "qt/digiwage/qtutils.cpp"
                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("DIGIWAGE Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersionWithCodename());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About DIGIWAGE Core"));
        ...
        licenseInfoHTML.replace(uri, "<a style='color: #fcdd1f;text-decoration:none'  href=\"\\1\">\\1</a>");
        ...
        QString header = tr("Usage:") + "\n" +
                "  digiwage-qt [" + tr("command-line options") + "]                     " + "\n";
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
            tr("DIGIWAGE Core is shutting down...") + "<br /><br />" +
