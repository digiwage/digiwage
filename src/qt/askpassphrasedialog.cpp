...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            DIGIWAGEGUI* window = static_cast<DIGIWAGEGUI*>(parentWidget());
...
{
    DIGIWAGEGUI* gui = static_cast<DIGIWAGEGUI*>(parentWidget());
...
{
    hide();
    static_cast<DIGIWAGEGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
