#ifndef DIGIWAGEHWITOOL_H
#define DIGIWAGEHWITOOL_H
...
/**
 * @brief The DigiWageHwiTool class Communicate with the DigiWage Hardware Wallet Interface Tool
 */
class DigiWageHwiTool : public QObject
{
    Q_OBJECT
public:
    /**
     * @brief DigiWageHwiTool Constructor
     * @param parent Parent object
     */
    explicit DigiWageHwiTool(QObject *parent = nullptr);

    /**
     * @brief ~DigiWageHwiTool Destructor
     */
    ~DigiWageHwiTool();
...
private:
    ...
    DigiWageHwiToolPriv* d;
};

#endif // DIGIWAGEHWITOOL_H
