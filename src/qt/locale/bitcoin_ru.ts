...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Это ваши digiwage-адреса для отправки платежей. Всегда проверяйте сумму и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
...
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation type="unfinished">Это ваши digiwage-адреса для приема платежей. Используйте кнопку "Создать новый адрес получения" на вкладке получения, чтобы создать новые адреса.
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Предупреждение: если вы зашифруете кошелёк и потеряете парольную фразу, вы &lt;b&gt;ПОТЕРЯЕТЕ ВСЕ ВАШИ DIGIWAGES&lt;/b&gt;!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Помните, что шифрование кошелька не может полностью защитить ваши digiwageы от кражи вредоносными программами, заразившими ваш компьютер.</translation>
   </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Введите digiwage-адрес (например,%1)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Отправить средства на DigiWage адрес</translation> 
   </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Подписать сообщения своими DigiWage кошельками, что-бы доказать, что вы ими владеете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Проверяйте сообщения, чтобы убедиться, что они подписаны конкретными digiwage-адресами</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Запросить платёж (генерирует QR-коды и URI протокола digiwage:)</translation> 
   </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Загрузить частично подписанную digiwage-транзакцию (PSBT)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Загрузить частично подписанную digiwage-транзакцию из буфера обмена</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Открыть URI протокола digiwage:</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <extracomment>A substring of the tooltip.</extracomment>
        <translation type="unfinished">
            <numerusform>%n активное подключение к сети DigiWage.</numerusform>
            <numerusform>%n активных подключения к сети DigiWage.</numerusform>
            <numerusform>%n активных подключений к сети DigiWage.</numerusform>
        </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Введенный адрес "%1" недействителен в сети DigiWage.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%1будет скачано и сохранит копию цепи блоков DigiWage</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Недавние транзакции могут быть пока не видны, и поэтому отображаемый баланс вашего кошелька может быть неточной. Информация станет точной после завершения синхронизации с сетью digiwage. Прогресс синхронизации вы можете видеть снизу.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Открыть URI digiwageа</translation>
   </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Показать элементы управления частично подписанными digiwage-транзакциями (PSBT)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Автоматически открыть порт digiwage-клиента на маршрутизаторе. Работает, если ваш маршрутизатор поддерживает UPnP, и данная функция на нём включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Автоматически открыть порт digiwage-клиента на роутере. Сработает только если ваш роутер поддерживает NAT-PMP, и данная функция на нём включена. Внешний порт может быть случайным.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Подключиться к сети digiwageа через SOCKS5 прокси.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Подключаться к сети DigiWage через отдельный SOCKS5 прокси для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Отображаемая информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью digiwageа после подключения, и этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Не удаётся запустить обработчик click-to-pay для протокола digiwage:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">"digiwage://" — это неверный URI. Используйте вместо него "digiwage:".</translation>
    </message>
    <message>
...
Если вы получили эту ошибку, вам следует попросить у продавца URI, совместимый с BIP21.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Не удалось обработать URI! Это может быть вызвано тем, что digiwage-адрес неверен или параметры URI сформированы неправильно.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Внимание: это сообщение не будет отправлено вместе с платежом через сеть DigiWageа.</translation>
   </message>
    <message>
...
Примечание: комиссия рассчитывается пропорционально размеру в байтах. Так при комиссии "100 сатоши за kvB (виртуальный КБ)" для транзакции размером 500 виртуальных байт (половина 1 kvB) комиссия будет всего 50 сатоши.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Создает частично подписанную digiwage-транзакцию (PSBT), чтобы использовать её, например, с офлайновым кошельком %1, или PSBT-совместимым аппаратным кошельком.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Пожалуйста, проверьте черновик вашей транзакции. Будет создана частично подписанная digiwage-транзакция (PSBT), которую можно сохранить или скопировать, после чего подписать, например, офлайновым кошельком %1 или PSBT-совместимым аппаратным кошельком.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Внимание: неверный digiwage-адрес</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">DigiWage-адрес, на который нужно отправить платёж</translation>
    </message>
    <message>
        <source>Paste address from clipboard</source>
        <translation type="unfinished">Вставить адрес из буфера обмена</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Комиссия будет вычтена из отправляемой суммы. Получателю придёт меньше digiwageов, чем вы ввели в поле "Сумма". Если выбрано несколько получателей, комиссия распределится поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Сообщение, которое было прикреплено к URI. Оно будет сохранено вместе с транзакцией для вашего удобства. Обратите внимание: это сообщение не будет отправлено в сеть DigiWage.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Вы можете подписывать сообщения/соглашения своими адресами, чтобы доказать, что вы можете получать digiwageы на них. Будьте осторожны и не подписывайте непонятные или случайные сообщения, так как мошенники могут таким образом пытаться присвоить вашу личность. Подписывайте только такие сообщения, с которыми вы согласны вплоть до мелочей.</translation>
    </message>
    <message>
        <source>The DigiWage address to sign the message with</source>
        <translation type="unfinished">DigiWage-адрес, которым подписать сообщение</translation> 
   </message>
    <message>
        <source>Choose previously used address</source>
        <translation type="unfinished">Выбрать ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Подписать сообщение, чтобы доказать владение digiwage-адресом</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation type="unfinished">Подписать &amp;сообщение</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Проверить сообщение, чтобы убедиться, что оно действительно подписано указанным digiwage-адресом</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation type="unfinished">Проверить &amp;сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%s испорчен. Попробуйте восстановить его с помощью инструмента digiwage-wallet или из резервной копии.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ошибка: версия дамп-файла не поддерживается. Эта версия digiwage-кошелька поддерживает только дамп-файлы версии 1. Обнаружен дамп-файл версии %s</translation>
    </message>
    <message>
