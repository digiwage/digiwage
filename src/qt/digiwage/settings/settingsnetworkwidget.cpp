...
#include "qt/digiwage/settings/settingsnetworkwidget.h"
#include "qt/digiwage/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/digiwage/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(DIGIWAGEGUI* _window, QWidget *parent) :
