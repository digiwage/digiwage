...
#include "qt/digiwage/settings/settingsexportcsv.h"
#include "qt/digiwage/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(DIGIWAGEGUI* _window, QWidget *parent) :
