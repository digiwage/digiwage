...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DIGIWAGE Core"),
     ...
     * override -datadir in the digiwage.conf file in the default data directory
     * (to be consistent with digiwaged behavior)
     */
