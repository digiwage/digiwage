#ifndef DIGIWAGE_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
#define DIGIWAGE_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
...
#endif // DIGIWAGE_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
