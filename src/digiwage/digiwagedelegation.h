#ifndef DIGIWAGEDELEGATION_H
#define DIGIWAGEDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The IDigiWageStaker class Delegation filter
 */
...
/**
 * @brief The DigiWageDelegation class Communicate with the digiwage delegation contract
 */
class DigiWageDelegation {
    
public:
    /**
     * @brief DigiWageDelegation Constructor
     */
    DigiWageDelegation();

    /**
     * @brief ~DigiWageDelegation Destructor
     */
    virtual ~DigiWageDelegation();
...
private:
    DigiWageDelegation(const DigiWageDelegation&);
    DigiWageDelegation& operator=(const DigiWageDelegation&);
    DigiWageDelegationPriv* priv;
};
#endif
