#ifndef DIGIWAGEDGP_H
#define DIGIWAGEDGP_H
...
public:
    ...
    DigiWageDGP(DigiWageState* _state, Chainstate& _chainstate, bool _dgpevm = true) : dgpevm(_dgpevm), state(_state), chainstate(_chainstate) { initDataSchedule(); }
