#ifndef DIGIWAGETOKEN_H
#define DIGIWAGETOKEN_H
#include <string>
#include <vector>
#include <map>
#include <uint256.h>
...
public:
    DigiWageToken();
    virtual ~DigiWageToken();

    void setDigiWageTokenExec(DigiWageTokenExec* tokenExec);
    ...
    // Static functions
    static bool ToHash160(const std::string& strDigiWageAddress, std::string& strHash160);
    static bool ToDigiWageAddress(const std::string& strHash160, std::string& strDigiWageAddress);
...
private:
    ...
    DigiWageToken(DigiWageToken const&);
    DigiWageToken& operator=(DigiWageToken const&);

private:
    DigiWageTokenData* d;
};

#endif // DIGIWAGETOKEN_H
