#ifndef DIGIWAGELEDGER_H
#define DIGIWAGELEDGER_H
...
/**
 * @brief The DigiWageLedger class Communicate with the digiwage ledger
 */
class DigiWageLedger {
    
public:
    /**
     * @brief DigiWageLedger Constructor
     */
    DigiWageLedger();

    /**
     * @brief ~DigiWageLedger Destructor
     */
    virtual ~DigiWageLedger();
     ...
     * @return
     */
    static DigiWageLedger &instance();
...
private:
    DigiWageLedger(const DigiWageLedger&);
    DigiWageLedger& operator=(const DigiWageLedger&);
    DigiWageLedgerPriv* d;
};
#endif
