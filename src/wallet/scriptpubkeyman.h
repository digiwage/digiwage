...
public:
    ...
    virtual SigningResult SignMessage(const std::string& message, const PKHash& pkhash, std::string& str_sig, const std::string& magic = MESSAGE_MAGIC) const { return SigningResult::SIGNING_FAILED; };
...
public:
    ...
    SigningResult SignMessage(const std::string& message, const PKHash& pkhash, std::string& str_sig, const std::string& magic = MESSAGE_MAGIC) const override;
