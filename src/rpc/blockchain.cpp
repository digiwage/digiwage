...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    if (block.IsProofOfStake()) {
        ...
        std::string stakeModifier = (Params().GetConsensus().NetworkUpgradeActive(blockindex->nHeight, Consensus::UPGRADE_POS_V2) ?
...
UniValue gettxout(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "  \"value\" : x.xxx,           (numeric) The transaction value in WAGE\n"
...
static UniValue SoftForkMajorityDesc(int version, const CBlockIndex* pindex, const Consensus::Params& consensusParams)
{
    ...
    case 3:
        ...
        break;
    case 4:
        idx = Consensus::UPGRADE_BLOCK_V4;
        break;
    case 5:
        idx = Consensus::UPGRADE_BIP65_TV2_MSG2;
        break;
    default:
