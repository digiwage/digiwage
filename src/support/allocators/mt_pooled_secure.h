...
#ifndef DIGIWAGE_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define DIGIWAGE_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif // DIGIWAGE_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
