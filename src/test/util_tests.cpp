...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("digiwage"), "Pivx");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://digiwage.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/digiwage"));
    BOOST_CHECK(validateURL("https://foo.bar/digiwage/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.digiwage.com"));
