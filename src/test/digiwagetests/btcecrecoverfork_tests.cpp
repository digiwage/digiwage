...
//    initState();
    ...
    std::vector<DigiWageTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createDigiWageTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createDigiWageTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createDigiWageTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createDigiWageTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
