...
This document provides guidelines for internationalization of the DIGIWAGE Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `digiwage_en.ts` remains unchanged.
