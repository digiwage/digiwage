...
The script [extract-osx-sdk.sh](https://github.com/digiwage-project/digiwage/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
digiwage/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/digiwage-project/digiwage/blob/master/doc/README_osx.md) for troubleshooting tips.