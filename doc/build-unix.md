 ...
 **For Ubuntu only:** db4.8 packages are available [here](https://launchpad.net/~digiwage/+archive/digiwage).
 You can add the repository using the following command:

    sudo apt-get install software-properties-common
    sudo add-apt-repository ppa:digiwage/digiwage
    sudo apt-get update
...
To build DIGIWAGE Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
