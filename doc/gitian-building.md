...
*Setup instructions for a gitian build of Digiwage using a Debian VM or physical system.*
...
- [Building Digiwage](#building-digiwage)
...
To build Digiwage (for Linux, OSX and Windows) just follow the steps under 'perform
